...
impl App {
    pub fn new() -> App {
        ...
        //        cfg_if! {
        //            if #[cfg(target_arch = "wasm32")] {
        //                let server_ip_address: IpAddr =
        // "192.168.86.38".parse().expect("couldn't parse input IP address"); // Put
        // your Server's IP Address here!, can't easily find this automatically from the
        // browser            } else {
        //                let server_ip_address = find_my_ip_address().expect("can't
        // find ip address");            }
        //        }
        //
        //        let server_socket_address = SocketAddr::new(server_ip_address,
        // SERVER_PORT);
        //
    ...
    pub fn update(&mut self) {
        ...
        // self.message_count += 1;                                let
        // to_server_message: String = PING_MSG.to_string();
