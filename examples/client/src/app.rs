...
impl App {
    pub fn new() -> App {
        ...
        cfg_if! {
            if #[cfg(target_arch = "wasm32")] {
                let server_ip_address: IpAddr = "192.168.86.41".parse().expect("couldn't parse input IP address"); // Put your Server's IP Address here!, can't easily find this automatically from the browser
            } else {
